  ...
  return (
    ...
    <div className="bg-primaryText flex p-4 md:px-16 justify-between items-center text-primary">
      ...
      <ul className="gap-4 hidden md:flex">
        ...
        {
            isOpen?<HiMenuAlt2 onClick={openNavBar}/>:
            <HiMenuAlt3 onClick={openNavBar}/>
        }
        </div>
      
    </div>
    <div className={`bg-primaryText  text-primary absolute ${isOpen?"left-[0]":"left-[-80%]"} w-[80%] transition-all  items-center fle justify-center`}>
